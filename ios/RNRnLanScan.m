...
-(void)lanScanDidFindNewDevice:(MMDevice*)device{
    ...
    if (![connectedDevicesMutable containsObject:device]) {
        NSMutableArray *nDevices = [[NSMutableArray alloc] initWithObjects:device.ipAddress,device.hostname,device.macAddress,device.isLocalDevice,device.macAddress,device.subnetMask, nil];
